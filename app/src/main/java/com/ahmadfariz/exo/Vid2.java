...
public class Vid2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("https://res.cloudinary.com/cryptone/video/upload/v1615174041/animequ.daily-20210308-0002_njanru.mp4");
        ...
        simpleExoPlayer = ExoPlayerFactory.newSimpleInstance(
                Vid2.this,trackSelector,loadControl
        );
